...
export default function WalletActions() {
  ...
  const operationItemsBottom: OperationItem[] = [
    ...
    { logo: <ExchangeLogo />, text: "Обменять", onClick: () => navigate('/rufin') },
  ];
    ...
    <div className="mt-6 mb-10">
      ...
      <div className="mt-4 flex flex-col items-start gap-2 self-stretch">
        <div className="flex w-full items-center justify-between px-2">
          <div className="text-[14px] font-bold leading-normal text-white">Карты</div>
          <button
            type="button"
            onClick={() => navigate('/new-card', { state: { backTo: '/wallet' } })}
            className="flex items-center gap-1 text-[13px] font-medium leading-[100%] tracking-[0] text-white/60"
          >
            <AddCardPlusIcon />
